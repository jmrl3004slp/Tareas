...
public class DialogAddWork extends DialogFragment {
    ...
    public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
        ...
        builder.setView(inflater.inflate(R.layout.dialog_add_tarea, null))
                .setTitle("Añadir tarea")
                .setPositiveButton(android.R.string.yes,  new DialogInterface.OnClickListener(){
                    @Override
                    public void onClick(DialogInterface dialogInterface, int i) {
                        EditText etnombre = getDialog().findViewById(R.id.etAddTarea);
                        ...
                        if (!tarea.equals("")) {
                            ...
                            mViewModel.Create(new TareasEntity(tarea));
